...
@section('breadcrumb')
    <div class="col-sm-6">
        <h4 class="page-title text-left">{{__('global.groups')}}</h4>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{route("admin")}}">{{__('global.home')}}</a></li>
            <li class="breadcrumb-item"><a href="javascript:void(0);">{{__('global.groups')}}</a></li>
            <li class="breadcrumb-item"><a href="javascript:void(0);">{{__('global.groups')}} {{__('global.list')}}</a></li>
...
@endsection
@section('button')
    <a href="#addnew" data-toggle="modal" class="btn btn-success btn-sm btn-flat"><i class="mdi mdi-plus mr-2"></i>{{__('global.ngroup')}}</a>
                                    ...
                                    @foreach ($positions as $position)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="#edit{{ $position->slug }}" data-toggle="modal"
                                                    class="btn btn-success btn-sm edit btn-flat"><i class='fa fa-edit'></i>
                                                    </a>
                                                <a href="#delete{{ $position->slug }}" data-toggle="modal"
