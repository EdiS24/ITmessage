                                ...
                                <div class="card bg-secondary text-white">
                                    <div class="card-body">
                                        <div class="mb-4">
                                            ...
                                            <h5 class="font-16 text-uppercase mt-0 text-white-50">{{__('global.all')}} <br> {{__('global.members')}}</h5> 
                                        </div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-secondary text-white">
                                    <div class="card-body">
                                        <div class="mb-4">
                                            <div class="float-left mini-stat-img mr-4">
                                                <i class="ti-panel" style="font-size: 30px"></i>
                                            </div>
                                            <h5 class="font-16 text-uppercase mt-0 text-white-50">{{__('global.all2')}} <br> {{__('global.groups')}}</h5>
                                            
                                             
                                        </div>
                                        <h1 class="font-500 float-right">{{$data[1]}} <i class=" text-success ml-2"></i></h1>
                                        <span class="ti-clipboard float-left" style="font-size: 71px"></span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-secondary text-white">
                                    <div class="card-body">
                                        <div class="mb-4">
                                            ...
                                            <h5 class="font-16 text-uppercase mt-0 text-white-50">{{__('global.all')}} <br> {{__('global.notifications')}}</h5> 
                                        </div>
                                        <h1 class="font-500 float-right">{{$data[3]}} </h1>
                                        <span class="ti-alarm-clock float-left" style="font-size: 71px"></span>
                                    </div>
                                </div>
                            </div>
                        </div>
