...
<div class="modal fade" id="addnew">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <h5 class="modal-title"><b>{{__('global.ngroup')}}</b></h5>
                    ...
                    <div class="form-group">
                        <label for="name"  class="col-sm-6 control-label">{{__('global.title')}}<i> { {{__('global.noSpace')}} }</i></label>
                            ...
                            <div class="bootstrap-timepicker">
                                <input type="text" placeholder="Enter a Graup name [hypen accepted]" class="form-control timepicker" id="name" name="slug">
                            </div>
                    </div>
                    {{-- <div class="form-group">
