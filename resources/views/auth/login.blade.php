    ...
    <div class="wrapper-page">
        <div class="card overflow-hidden account-card mx-3">
            <div class="bg-secondary p-4 text-white text-center position-relative">
                <h4 class="font-20 m-b-5">IT Solutions</h4>
            ...
            <div class="account-card-content">
                <form class="form-horizontal m-t-30" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="form-group">
                        <label for="email" class="col-form-label ">{{ __('global.login_email') }}</label>
                    ...
                    <div class="form-group row m-t-20">
                        ...
                        <div class="col-sm-6 text-right">
                            <button class="btn btn-success w-md waves-effect waves-light" type="submit">{{ __('global.login') }}</button>
                        </div>
                    </div>
